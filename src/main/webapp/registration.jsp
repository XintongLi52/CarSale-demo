    ...
    <div class="col-md-9">
        ...
        <form action="reg" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="mobile" id="exampleInputMobile" aria-describedby="emailHelp" placeholder="Enter mobile">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="file" class="form-control" name="photo" id="exampleInputPhoto" placeholder="upload photo">
            </div>
